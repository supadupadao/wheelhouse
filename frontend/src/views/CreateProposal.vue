<template>
  ...
  <div class="block max-w-md">
    <input
      type="text"
      class="input default w-full max-w-md"
      placeholder="Proposal receiver address"
      v-model="proposalReceiver"
    />
    <input
      type="text"
      class="input default w-full max-w-md"
      placeholder="Proposal payload in base64"
      v-model="proposalPayload"
    />
    <input
      type="number"
      class="input default w-full max-w-md"
      placeholder="Proposal amount in nanoTONs"
      v-model.number="proposalAmount"
    />
  </div>
